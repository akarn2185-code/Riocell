    ...
    <div class="py-6 sm:py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
                <form method="POST" action="{{ route('owner.products.update', $product) }}" enctype="multipart/form-data" class="p-4 sm:p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 italic">Biarkan kosong jika tidak ingin mengubah foto. Format: JPG, JPEG, PNG (Maks 2MB)</p>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="type" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                    ...
                                    <option value="fisik" {{ old('type', $product->type) == 'fisik' ? 'selected' : '' }}>Fisik</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="buy_price" value="{{ old('buy_price', $product->buy_price) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ old('description', $product->description) }}</textarea>
                        </div>
                    ...
                    <div class="mt-6 flex gap-3">
                        <button type="submit" class="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition shadow-md">
                            Simpan Perubahan
                        </button>
